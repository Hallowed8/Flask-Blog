...
@app.route("/posst/<int:post_id>/delete", methods=['POST'])
@login_required
...
def send_reset_email(user):
    ...
    If you did not make this request then simply ignore this link to retain your current password.
    Kind regards,
    flask-blog.com 
    '''
    mail.send(msg)
